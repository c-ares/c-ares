...
/* Legacy compatibility.  Use ares_channel_t instead */
...
CARES_EXTERN void ares_set_socket_configure_callback(ares_channel_t *channel,
...
CARES_EXTERN void ares_set_socket_functions(ares_channel_t *channel,
					    const struct ares_socket_functions * funcs,
					    void *user_data);

CARES_EXTERN void ares_send(ares_channel_t *channel,
                            const unsigned char *qbuf,
                            int qlen,
                            ares_callback callback,
                            void *arg);

CARES_EXTERN void ares_query(ares_channel_t *channel,
                             const char *name,
                             int dnsclass,
                             int type,
                             ares_callback callback,
...
CARES_EXTERN void ares_search(ares_channel_t *channel,
                              const char *name,
                              int dnsclass,
                              int type,
                              ares_callback callback,
...
CARES_EXTERN void ares_gethostbyname(ares_channel_t *channel,
                                     const char *name,
                                     int family,
...
CARES_EXTERN void ares_gethostbyaddr(ares_channel_t *channel,
                                     const void *addr,
                                     int addrlen,
                                     int family,
                                     ares_host_callback callback,
...
CARES_EXTERN void ares_process(ares_channel_t *channel,
                               fd_set *read_fds,
                               fd_set *write_fds);
